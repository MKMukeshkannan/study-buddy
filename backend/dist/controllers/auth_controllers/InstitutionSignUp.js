...
export default async function institute_signup(req, res) {
    if (!req.body)
        return;
    const { password, phone_number, founded_year, address, logo_url, mail, name, website, } = InstitutionCreation.parse(req.body);
...
//# sourceMappingURL=InstitutionSignUp.js.map